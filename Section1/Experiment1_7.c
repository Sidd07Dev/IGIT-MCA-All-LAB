//This program is designed for the purpose  of swap two numbers without using a third variable.
#include<stdio.h> //importing the standard input output library
//here main function started
int main(){
int num1,num2;
printf("This program works for swapping two numbers without using a third variable\n");
